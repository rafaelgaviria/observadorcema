                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('document') ? ' has-error' : '' }}">
                            <label for="document" class="col-md-4 control-label">Número documento</label>

                            <div class="col-md-6">
                                <input id="document" type="document" class="form-control" name="document" value="{{ old('document') }}" required>
